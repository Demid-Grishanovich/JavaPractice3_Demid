...
public void TestConstructors(){
    ...
    assertEquals("Iphone", purchase.getNAME());
    assertEquals(70099, purchase.getPRICE());
    ...
    public void testGetCost(){
        ...
        Purchase purchase2 = new Purchase(10, 10, WeekDay.Monday);
        assertEquals(630900, purchase2.getCost());
        Purchase purchase3 = new Purchase(3, 0, WeekDay.Sunday);
        assertEquals(210300, purchase3.getCost());
    }
    @Test
